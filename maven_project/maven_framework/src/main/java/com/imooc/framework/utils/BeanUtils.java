...
public class BeanUtils {
	//@update by FengMy SimpleDateFormat非线程安全，作为静态属性调用会出现线程调试异常
//	private static final SimpleDateFormat DATEFORAT = new SimpleDateFormat("yyyy-MM-dd");
//	private static final SimpleDateFormat TIMEFORAT = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	...
	private static void setValueToEntity(Method setter,Method getter,Object entity,String value) throws Exception{
		...
		if (value != null && !value.equals("") && !"[object Object]".equals(value)) {
